export let adminPanelUserList = `
  <div class="actionListRoot">
    <div class="infoBlock">
      <div class="info"></div>
      <div class="infoRect"></div>
    </div>
    <div class="infoAddCont">
      <span class="infoAddSpan"></span>
      <input>
      <button></button>
    </div>
  </div>
`
export let adminPanelInfoListItem = `
    <div class="listItem">
        <span></span>
